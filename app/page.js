      ...
      resources: [
        {
          ...
          links: [
            { name: "IndiaBix", url: "https://www.indiabix.com/" },
            {
              ...
              url: "https://placement.freshersworld.com/logical-reasoning-questions-and-answers/33150830",
            },
            {
      ...
      resources: [
        {
          ...
          links: [
            { name: "Insider Tips", url: "https://www.ambitionbox.com/" },
            {
              ...
              url: "https://www.hackerrank.com/interviewstreet",
            },
          ...
          <div className="mt-16 bg-white rounded-xl shadow-lg overflow-hidden">
            <div className="p-8 md:p-12 text-center">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto mb-8">
                Explore supplementary resources to enhance your interview and
